...
class AlienInvasion:
    ...
    def _fire_bullet(self) -> None:
        """Dispara um projétil se o limite de projéteis ainda não estiver sido alcançado."""
    ...
    def _update_aliens(self) -> None:
        """Verifica se a frota alienígena está em uma borda, então atualiza as posições de todos os alienígenas na frota."""
    ...
    def _change_fleet_direction(self) -> None:
        """Desce a frota e muda a direção"""
        for alien in self.aliens.sprites():
    ...
    def _update_game_statue(self) -> None:
